 ...
 * @version $Id: BreadthFirstSolver.php,v 1.3 2005/12/09 01:11:08 brpreiss Exp $
 * @package Opus11
 */
...
//}>a
    ...
    {
        printf("BreadthFirstSolver main program.\n");
        $status = 0;
        return $status;
    }
}
...
{
    exit(BreadthFirstSolver::main(array_slice($argv, 1)));
}
?>
